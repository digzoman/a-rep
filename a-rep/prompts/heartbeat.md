...
13. Update the relevant work Issue and material durable state. Keep Issue 1 concise and current. Append to Issue 3 only for material cross-cutting actions, failures, recoveries, incidents, or major state transitions that belong beyond a dedicated work/runtime record.
