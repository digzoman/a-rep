...
This is the canonical V1 private-agent repository structure.
...
Accepted A Rep releases may also ship approved generic capabilities in the canonical scaffold. V1.5 includes optional `plan-work` and `data-ledger`; their live artifacts stay under `work/` and are created only when actual work warrants them.
